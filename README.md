# 📖 Book Reader by Belurus — EPUB & PDF Reader for Obsidian
...
- **EPUB formatting toggle:** preserve the book's original styles, fonts, images and layout, or switch to a simplified text-oriented view.
...
2. Command palette → **BRAT: Add a beta plugin**, and paste the repo:
   ```
   swayinfobrain/belurus-reader-books
   ```
...
2. Copy them into `<your-vault>/.obsidian/plugins/belurus-reader-books/`.
3. Restart Obsidian → **Settings → Community plugins** → enable **Book Reader by Belurus**.
...
Made by **Belurus**. Follow along, ask questions, and suggest features:

- ▶️ **YouTube:** [@belurus](https://www.youtube.com/@belurus)
- ✈️ **Telegram:** [@belurus](https://t.me/belurus)
...
# 📖 Book Reader by Belurus — читалка EPUB и PDF для Obsidian (Русская версия)
...
### Чтение
- **Форматы:** EPUB и PDF.
- **Переключатель форматирования EPUB:** оригинальные стили, шрифты, изображения и вёрстка книги либо упрощённый текстовый режим.
...
2. В поле репозитория вставьте:
   ...
   swayinfobrain/belurus-reader-books
   ```
   *(или полный URL: `https://github.com/swayinfobrain/belurus-reader-books`)*
...
2. Скопируйте их в папку:
   ```
   <ваш-vault>/.obsidian/plugins/belurus-reader-books/
   ```
3. Перезапустите Obsidian → Настройки → Сторонние плагины → включите **Book Reader by Belurus**.
...
Автор — **Belurus**. Подписывайтесь, задавайте вопросы и предлагайте идеи:
